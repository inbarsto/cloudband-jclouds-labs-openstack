...
public class ImageApiLiveTest extends BaseGlanceApiLiveTest {
   ...
   public void init() {
      ...
      updatedImageName = IMAGE_NAME_PREFIX.concat("2") + random.nextInt();
   }

   @AfterClass
   public void tearDown() {
      for (String region : api.getConfiguredZones()) {
         cleanImagesByRegionAndName(region, imageName);
         cleanImagesByRegionAndName(region, updatedImageName);
      }
   }
   ...
   private void cleanImagesByRegionAndName(String region, String imageName) {
